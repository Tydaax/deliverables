...
<?php if( 'page' == get_option( 'show_on_front' ) ): ?>
	...
	<?php 
		...
		if( 'woo-one' == get_theme_mod('business_magna_layout_type') ){
			
			get_template_part( 'template-parts/woo-one' );
			
		}elseif( 'two' == get_theme_mod('business_magna_layout_type') ){
			
			get_template_part( 'template-parts/two' );
			
		}elseif( 'seven' == get_theme_mod('business_magna_layout_type') ){
			
			get_template_part( 'template-parts/seven' );
			
		}elseif( 'nine' == get_theme_mod('business_magna_layout_type') ){
			
			get_template_part( 'template-parts/nine' );
			
		}else{
			
			get_template_part( 'template-parts/one' );
