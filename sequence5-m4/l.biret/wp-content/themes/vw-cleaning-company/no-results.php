...
<h1 class="entry-title"><?php esc_html_e( 'Nothing Found', 'vw-cleaning-company' ); ?></h1>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<div class="more-btn">
		<a href="<?php echo esc_url(home_url() ); ?>" alt="<?php esc_html_e( 'Go Back', 'vw-cleaning-company' ); ?>"><i class="fas fa-angle-right"></i><?php esc_html_e( 'Go Back', 'vw-cleaning-company' ); ?></a>
	</div>
<?php endif; ?>